...
import { signup } from "@/api/functions/authApi";
...
const theme = createTheme({
  ...
  palette: {
    primary: {
      main: "#FF6B6B", // Soft red for primary action buttons
    },
    secondary: {
      main: "#6C63FF", // Purple for background and accents
    },
  },
});
...
// Styled TextField with floating label animations
const FloatingTextField = styled(TextField)({
  "& label": {
    transition: "all 0.3s ease",
  },
  "& .Mui-focused label": {
    color: "#FF6B6B", // Color change on focus
  },
  "& .MuiOutlinedInput-root": {
    ...
    "&:hover fieldset": {
      borderColor: "#FF6B6B", // Border color on hover
    },
    "&.Mui-focused fieldset": {
      borderColor: "#FF6B6B", // Border color when focused
    },
  },
});
